...
<body>
    <div class="cont-main" style="background:url(<?php echo ASSETS .'images/3.jpg';?>)">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                <?php 
                if (isset($_POST['submit'])) 
                {
                    ...
                    if (checkEmpty($mobile) && checkEmpty($name)) 
                    {
                        ...
                        $sql  = "INSERT INTO orders (`order_name`,`order_email`,`order_mobile`,`order_serv_id`,`order_city_id`,`order_notes`)
                            VALUES ('$name','$email','$mobile','$service','$city','$notes')                                                  /* inset order in database and admins*/
                        ";
                        $success_message = db_insert($sql);   /* add success message and added database*/
                    }
                    else 
                    {
                        $error_message = "Please Type Your Name And Your Mobile"; /* message error  */
                    } 
                }
        ?>
                <form style="background-color: light ; border:none ;" class="row" class="text-light bg-dark"  method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="mt-5" >
                    <?php require BL.'functions/messages.php'; ?>

                    
                    <div class="col-sm-6 " class="text-light bg-dark" >
                    ...
                    <div class="col-sm-12">
                        <div  class="form-group"  >
                            <button type="submit" name="submit"  class="btn btn-success form-control" style="background-color: black ; border-radius:45px;">Send</button>
                        </div>
                    </div>
